          ...
          <div className="w-3/5 p-5">
            ...
            <div className="py-10">
              ...
              <div className="flex flex-col items-center ">
                ...
                >
                  <Link href="/">Accédez</Link>
                </button>
              </div>
            </div>
          </div>
          {/* ----------sign up section------------ */}
          <div className="w-2/5 bg-fuchsia-400 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12">
            ...
            <a className="border-2 border-white rounded-full py-2 px-12 inline-block font-semibold hover:bg-white hover:text-fuchsia-400  my-3">
